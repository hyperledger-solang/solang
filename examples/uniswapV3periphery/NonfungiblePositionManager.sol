...
import '../uniswapV3core/libraries/FixedPoint128.sol';
    ...
    SelfPermit
{
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        uint128 amount0Collect = params.amount0Max;
        if (amount0Collect > tokensOwed0) {
            amount0Collect = tokensOwed0;
        }

        uint128 amount1Collect = params.amount1Max;
        if (amount1Collect > tokensOwed1) {
    ...
    function _getAndIncrementNonce(uint256 tokenId) public override returns (uint256) {
