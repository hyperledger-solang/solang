...
describe('Deploy asserts contract and test', () => {
    ...
    it('asserts', async function () {
        ...
        expect(res1.result.toHuman()).toEqual({ "Err": { "Module": { "error": "12", "index": "18", "message": "ContractTrapped" } } });
        ...
        expect(res2.dispatchError.toHuman()).toEqual({ "Module": { "error": "12", "index": "18" } });
