...
"#;
    ...
    let errors = crate::parse(src, 0).unwrap_err();
    assert_eq!(
        errors,
        vec![
            Diagnostic {
            ...
            Diagnostic {
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token ';', expected string".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token 'for', expected \"(\", \";\", \"=\"".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token '9', expected \"case\", \"default\", \"leave\", \"revert\", \"switch\", identifier".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token '0', expected \"(\", \"++\", \"--\", \".\", \"[\", \"case\", \"constant\", \"default\", \"external\", \"immutable\", \"internal\", \"leave\", \"override\", \"private\", \"public\", \"revert\", \"switch\", \"{\", identifier".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token 'uint256', expected \"++\", \"--\", \".\", \"[\", \"case\", \"default\", \"leave\", \"switch\", identifier".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token '3', expected \"(\", \"++\", \"--\", \".\", \"[\", \"case\", \"constant\", \"default\", \"external\", \"immutable\", \"internal\", \"leave\", \"override\", \"private\", \"public\", \"revert\", \"switch\", \"{\", identifier".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token '4', expected \"(\", \"case\", \"default\", \"leave\", \"revert\", \"switch\", identifier".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token '!', expected \";\", \"case\", \"constant\", \"default\", \"external\", \"immutable\", \"internal\", \"leave\", \"override\", \"payable\", \"private\", \"public\", \"pure\", \"return\", \"returns\", \"revert\", \"switch\", \"view\", \"virtual\", \"{\", identifier".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token '3', expected \"!=\", \"%\", \"%=\", \"&\", \"&&\", \"&=\", \"(\", \"*\", \"**\", \"*=\", \"+\", \"++\", \"+=\", \"-\", \"--\", \"-=\", \".\", \"/\", \"/=\", \";\", \"<\", \"<<\", \"<<=\", \"<=\", \"=\", \"==\", \">\", \">=\", \">>\", \">>=\", \"?\", \"[\", \"^\", \"^=\", \"calldata\", \"case\", \"default\", \"leave\", \"memory\", \"revert\", \"storage\", \"switch\", \"{\", \"|\", \"|=\", \"||\", identifier".to_string(),
                notes: vec![],
            },
            Diagnostic {
                loc: File(
            ...
            Diagnostic {
                ...
                level: Error,
                ty: ParserError,
                message: "unrecognised token '}', expected \"(\", \";\", \"@\", \"[\", \"abstract\", \"address\", \"bool\", \"byte\", \"bytes\", \"case\", \"contract\", \"default\", \"enum\", \"event\", \"false\", \"function\", \"import\", \"interface\", \"leave\", \"library\", \"mapping\", \"payable\", \"pragma\", \"string\", \"struct\", \"switch\", \"true\", \"type\", \"using\", Bytes, Int, Uint, address, hexnumber, hexstring, identifier, number, rational, string".to_string(),
                notes: vec![],
            },
        ]
    )
