...
/// Ensure immutable are only mutated in the constructor
fn check_immutable(context: &ExprContext, ns: &mut Namespace, loc: &pt::Loc, immutable: &bool, diagnostics: &mut Diagnostics) -> () {
    if *immutable {
