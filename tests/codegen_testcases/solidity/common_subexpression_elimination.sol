...
contract c1 {
    ...
    function test1(int256 a, int256 b) public pure returns (int256) {
        int256 x;
    ...
    function test2(int256 a, int256 b) public pure returns (int256) {
        int256 x;
        // CHECK: ty:int256 %1.cse_temp = ((arg #0) + (arg #1))
        x = a + b - 54;
        // CHECK: ty:int256 %x = (%1.cse_temp - int256 54)
    ...
    function test3(int256 a, int256 b) public pure returns (int256) {
        int256 x;
        x = a + b - 54;
        int256 d = x * (a + b);
    ...
    function test4(int256 a, int256 b) public pure returns (int256) {
        int256 x;
        x = a + b - 54;
        int256 d = x * (a + b);
        int256 p = x + d;
    ...
    function test5(int256 a, int256 b) public pure returns (int256) {
        int256 x;
        x = a + b - 54;
        int256 d = x * (a + b);
    ...
    function test6(int256 a, int256 b) public pure returns (int256) {
        int256 x;
        x = a + b - 54;
        int256 d = x * (a + b);
    ...
    function test7(int256 a, int256 b) public pure returns (int256) {
        int256 x;
        // CHECK: ty:int256 %1.cse_temp = ((arg #0) + (arg #1))
        x = a + b - 54;
        // CHECK: ty:int256 %x = (%1.cse_temp - int256 54)
    ...
    function test9(int256 a, int256 b) public view returns (int256 ret) {
        stTest instance = stTest(2, 3);
        // CHECK:  ty:int256 %1.cse_temp = ((arg #0) + (arg #1))
        int256 x = a + b + instance.a;
    ...
    function test10(int256 a, int256 b) public pure returns (int256) {
        int256 x;
        x = a + b - 54;
        int256 d = x * (a + b);
        int256 k = x + d;
    ...
    function get(int256 a, int256 b) private pure returns (int256) {
        return a + b + 1;
    }

    event testEvent(int256 a, int256 b, string str);

    // BEGIN-CHECK: c1::function::test11
    function test11(int256 a, int256 b) public returns (int256) {
        string ast = "Hello!";
    ...
    function test12(int256 a, int256 b) public returns (int256) {
        int256 x = a + b;
        bool e = (x == a);
    ...
    function test13(int256 a, int256 b) public returns (int256) {
        string c = "Hello";
        bytes b1 = bytes(c);
        string b2 = string(b1);
        string b3 = b2;
        int256[4] vec = [1, 2, 3, 4];
        // CHECK: ty:int256 %1.cse_temp = ((arg #0) + (arg #1))
        int256 x = (a + b) - (vec[1] - vec[2]);
    ...
    function test14(int256 a, uint256 b) public returns (int256) {
        string c = "Hello";
        bytes b3 = bytes(c);
    ...
    function test15(uint256 a, uint256 b) public pure returns (uint256) {
        uint256 c = a << b;
        bool b1 = c > 0;
    ...
    function test16(int256 a, int256 b) public pure returns (int256) {
        int256 k = (a - b);
        bool e = k > 0;

        for (int256 i = 1; a - b < 0; i++) {
        ...
        uint256 p1 = uint256(a)**uint256(g);
        bool e9 = p1 == 0;
        ...
        return k / a + int256(uint256(a)**uint256(g));
    }
}
