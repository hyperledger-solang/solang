...
// error: 15:4-5: expected 'bytes slice[]', found integer
...
// error: 20:5-6: expected 'bytes slice', found integer
// error: 21:5-10: conversion from struct AccountMeta[1] to bytes not possible
// error: 22:4-15: type bytes found where array bytes slice expected
