...
fn struct_in_struct() {
    ...
    assert_eq!(
        vm.data()[0..52].to_vec(),
        vec![
            11, 66, 182, 57, 0, 0, 0, 0, 0, 0, 0, 0, 48, 0, 0, 0, 173, 222, 0, 0, 0, 0, 0, 0, 254,
            0, 0, 0, 102, 0, 0, 0, 114, 97, 98, 111, 111, 102, 0, 0, 210, 2, 150, 73, 0, 0, 0, 0,
            0, 0, 0, 0
        ]
    );
...
fn string_in_struct() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            56, 0, 0, 0, 0, 0, 0, 210, 2, 150, 73, 0, 0, 0, 0, 64, 0, 0, 0, 0, 0, 0, 0, 6, 0, 0, 0,
